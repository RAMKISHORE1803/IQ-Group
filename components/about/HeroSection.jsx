...
const HeroSection = ({ 
  ...
  return (
    <>
      <section 
        ref={heroRef} 
        className={`relative w-full ${showContactOptions ? 'h-[90svh] md:h-[90vh] lg:max-h-[80vh] mt-[-10vh]' : 'h-[100svh] md:h-screen lg:max-h-[80vh] mt-[-10vh]'} bg-white overflow-hidden`}
      >
