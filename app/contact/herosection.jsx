...
const HeroSection = ({ 
  ...
  return (
    <>
      <section 
        ref={heroRef} 
        className="relative w-full h-[100svh] md:h-screen lg:max-h-[78vh] bg-white overflow-hidden"
      >
        ...
        <div 
          ref={contentRef}
          className="hero-content relative z-10 h-[100svh] md:h-screen lg:left-[180px] flex flex-col justify-end pb-12 md:pb-4 px-4 sm:px-8 md:px-16 lg:pb-[260px] lg:max-w-5xl lg:px-24 xl:px-32"
        >
