    ...
    <>
      ...
      >
        ...
        <div className="absolute left-[150px] top-0 md:h-full hidden md:flex items-center z-10">
          ...
          <div 
            ref={sideTextRef}
            className="absolute bottom-[265px] min-w-[120px] left-[-25vw] md:left-[7vw] transform -translate-x-1/2 origin-bottom-left rotate-[-90deg] text-white font-semibold lg:text-[20px]"
          >
