      ...
      >
        ...
        <div className="absolute left-[25vw] top-0 h-full md:hidden flex items-center z-10">
          ...
          <div 
            ...
            className="absolute bottom-[30%] left-[8vw] transform -translate-x-1/2 origin-bottom-left rotate-[-90deg] text-white font-semibold text-[16px]"
          >
        ...
        <div className="absolute left-[150px] top-0 md:h-full hidden md:flex items-center z-10">
          ...
          <div 
            ref={sideTextRef}
            className="absolute bottom-[285px] min-w-[120px] left-[-25vw] md:left-[7vw] transform -translate-x-1/2 origin-bottom-left rotate-[-90deg] text-white font-bold lg:text-[20px]"
          >
