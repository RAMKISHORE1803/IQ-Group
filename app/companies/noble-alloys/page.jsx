...
const products = [
  {
    ...
    description: "High-purity ferro molybdenum alloys for steel manufacturing, providing enhanced strength and corrosion resistance."
  },
  {
    title: "Ferro Vanadium",
    description: "Premium ferro vanadium alloys that improve structural strength and fatigue resistance in steel production."
  },
  {
    title: "Ferro Tungsten",
    description: "Specialized ferro tungsten alloys for high-temperature applications, offering exceptional hardness and wear resistance."
  },
  {
    title: "Ferro Niobium",
    description: "Quality ferro niobium alloys that enhance weldability and formability in high-strength low-alloy steels."
  }
];
...
export default function NobleAlloysPage() {
  return (
    ...
    >
      ...
      {/* Products Section */}
      <ContentSection id="products" title="Our Products" subtitle="Premium noble alloys for specialized industrial applications">
